...
class RsvpsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rsvp" do
    assert_difference('Rsvp.count') do
      post rsvps_url, params: { rsvp: { food_bring: @rsvp.food_bring, head_count: @rsvp.head_count, name: @rsvp.name } }
    end
  ...
  test "should update rsvp" do
    patch rsvp_url(@rsvp), params: { rsvp: { food_bring: @rsvp.food_bring, head_count: @rsvp.head_count, name: @rsvp.name } }
